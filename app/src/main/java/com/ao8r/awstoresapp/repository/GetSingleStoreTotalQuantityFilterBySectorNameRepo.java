...
public class GetSingleStoreTotalQuantityFilterBySectorNameRepo {
    static Connection connection;

    public static void getSingleStoreTotalQuantityFilterBySectorName(Context context,int itemNo, ArrayList<AzonateModel> azonateList) {
        try {
...
//                        "  Having Round((SUM(A.in_quen)- SUM(A.out_quen)),2) <> 0\n" +
//                        "  Order By storeTotalQuantity Desc";
                  "EXEC [dbo].[ItemStoreQty_Sector] @ItemNo = ?, @StoreNo = 0, @SectorName = ?";
